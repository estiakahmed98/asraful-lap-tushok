...
const filters: Array<'সব' | ProductCategory> = ['সব', 'কাঁথা', 'বেডশিট', 'লেপ', 'তোষক', 'বালিশ']
