# Asraful Birds of eden Product JSON Guide
...
- `id`: ইউনিক stock code। কাঁথা `KTH`, বেডশিট `BST`, লেপ `LEP`, তোষক `TSK`, বালিশ ও পিলো কভার `BLS` দিয়ে শুরু করুন।
- `slug`: ইংরেজি ছোট হাতের অক্ষর ও hyphen; একই slug দুইবার নয়।
- `category`: শুধু `কাঁথা`, `বেডশিট`, `লেপ`, `তোষক`, অথবা `বালিশ` লিখুন।
