...
const categoryNames = ["কাঁথা", "বেডশিট", "লেপ", "তোষক", "বালিশ"] as const;
const categories = categoryNames.map((name) => {
  const matches = products.filter((product) => product.category === name);
  return {
    name,
    count: `${new Intl.NumberFormat("bn-BD").format(matches.length)} কালেকশন`,
        ...
        <section className="hero">
          <div className="hero-copy">
            ...
            <p className="hero-description">
              নরম কাঁথা, মুগ্ধ করা বেডশিট, উষ্ণ লেপ, বালিশ আর নিশ্চিন্ত ঘুমের
